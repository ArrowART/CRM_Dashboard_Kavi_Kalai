...
import { allocateteamleader, updateAllocation } from "../../services/apiunallocation/apiunallocation";
      ...
      {isLoading ? (
        ...
        >
          ...
          {selectedColumns.includes('Name') && (
            <Column field="Name" header="Name" sortable style={{ width: '25%' }} body={renderEditableCell}  />
          )}
          {selectedColumns.includes('Firm_Name') && (
            <Column field="Firm_Name" header="Firm Name"  body={renderEditableCell} />
          )}
           {selectedColumns.includes('Mobile1') && (
            <Column field="Mobile1" header="Mobile 1" body={(rowData, options) => renderEditableCell(rowData, { ...options, field: 'Mobile1' })} />
          )}
